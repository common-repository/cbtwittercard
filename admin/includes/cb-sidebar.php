<div class="wrap">
    ...
    <?php echo '<h2>' . __('CBX Twitter Card', 'cbtwittercard') . '</h2>'; ?>
            ...
            <div id="post-body-content">
                ...
                <div class="meta-box-sortables ui-sortable">
                    ...
                    <div class="postbox">
                        ...
                        <?php echo '<h3>' . __('Twitter Card Settings', 'cbtwittercard') . '</h3>'; ?>
                        ...
                        <div class="inside">
                            <div id="side-info-column">
                                <div class="postbox">
                                    <h3>Plugin Info</h3>
                                    <div class="inside">
                                        <p>Plugin Name : <a href="http://wpboxr.com/product/cbx-twitter-card" target="_blank">CBX Twitter Card</a></p>
                                        ...
                                        <p>Twitter : @<a href="http://twitter.com/wpboxr" target="_blank">WPBoxr</a></p>
                                        <p>Facebook : <a href="http://facebook.com/wpboxr" target="_blank">http://fb.com/wpboxr</a></p>
                                ...
                                <div class="postbox">
                                    <h3><?php _e('WPBoxr Other Plugins', 'cbtwittercard'); ?></h3>
                                    <div class="inside">
                                        <?php
                                ...
                                <div class="postbox">
                                    <div class="inside">
                                        <div class="inside">
                                            <h3><?php _e('Codeboxr Networks', 'cbtwittercard') ?></h3>
                                            <p><?php _e('Wordpress Plugins', 'cbtwittercard') ?></p>
                                            <a target="_blank" href="http://wpboxr.com"><img src="<?php echo plugins_url('../assets/img/wpboxr-logo-rect.png', __FILE__); ?>" style="max-width: 100%;" alt="wpboxr" title="WPBoxr - Wordpress Extracts"  /></a>
                                            <br/><br/>
                                            <p><?php _e('Html, Wordpress & Joomla Themes', 'cbtwittercard') ?></p>
                                            <a target="_blank" href="http://themeboxr.com"><img src="<?php echo plugins_url('../assets/img/themeboxr-logo-rect.png', __FILE__); ?>" style="max-width: 100%;" alt="themeboxr" title="Themeboxr - useful themes"  /></a>
                                            <br/>
                                            <p>Joomla Extensions</p>
                                            <a target="_blank" href="http://joomboxr.com"><img src="<?php echo plugins_url('../assets/img/joomboxr-logo-rect.png', __FILE__); ?>" style="max-width: 100%;" alt="joomboxr" title="Joomboxr - Joomla Extracts"  /></a>
                                        </div>
                                    </div>
                                </div>
